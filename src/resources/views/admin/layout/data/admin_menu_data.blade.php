                     ...
                     @can("admin.index")
                    <li>
                    <a @if(Route::currentRouteName() == "admin.index") class="active" @endif href="http://blade_package.test/admin">
...
<span>@lang("rrm::permission.admin.user.")</span>
                    ...
                    <a href="http://blade_package.test/admin/user/index">@lang("rrm::permission.admin.user.index")</a>
                    </li>
                    @endcan
                    
                    @can("admin.user.create")
                    <li @if(Route::currentRouteName() == "admin.user.create") class="active" @endif>
                    <a href="http://blade_package.test/admin/user/create">@lang("rrm::permission.admin.user.create")</a>
                    </li>
                    @endcan
                    </ul></li>
@endcan
...
<span>@lang("rrm::permission.admin.menu.")</span>
                    ...
                    <a href="http://blade_package.test/admin/menu/index">@lang("rrm::permission.admin.menu.index")</a>
                    </li>
                    @endcan
                    
                    @can("admin.menu.create")
                    <li @if(Route::currentRouteName() == "admin.menu.create") class="active" @endif>
                    <a href="http://blade_package.test/admin/menu/create">@lang("rrm::permission.admin.menu.create")</a>
                    </li>
                    @endcan
                    
                    @can("admin.menu.make")
                    <li @if(Route::currentRouteName() == "admin.menu.make") class="active" @endif>
                    <a href="http://blade_package.test/admin/menu/make">@lang("rrm::permission.admin.menu.make")</a>
                    </li>
                    @endcan
                    </ul></li>
@endcan
...
<span>@lang("rrm::permission.admin.role.")</span>
                    ...
                    <a href="http://blade_package.test/admin/role/index">@lang("rrm::permission.admin.role.index")</a>
                    </li>
                    @endcan
                    
                    @can("admin.role.create")
                    <li @if(Route::currentRouteName() == "admin.role.create") class="active" @endif>
                    <a href="http://blade_package.test/admin/role/create">@lang("rrm::permission.admin.role.create")</a>
                    </li>
                    @endcan
                    </ul></li>
@endcan
...
<span>@lang("rrm::permission.admin.permission.")</span>
                    ...
                    <a href="http://blade_package.test/admin/permission/index">@lang("rrm::permission.admin.permission.index")</a>
                    </li>
                    @endcan
                    
                    @can("admin.permission.reload")
                    <li @if(Route::currentRouteName() == "admin.permission.reload") class="active" @endif>
                    <a href="http://blade_package.test/admin/permission/reload">@lang("rrm::permission.admin.permission.reload")</a>
                    </li>
                    @endcan
                    </ul></li>
@endcan
