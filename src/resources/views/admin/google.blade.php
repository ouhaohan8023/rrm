...
<body onload="startTime()">
	<div class="container">
        <div>
            @if(Session::has('msg'))
                <div class="notice">操作錯誤：{{ Session::get('msg') }}</div>
            @endif
        </div>
		<div class="discription">
	    	...
	    	<div class="appdownloadcode">
				<ul>
					<li>
						<img src="{{asset('admin_panel/img/google/ios.png?').config('admin.resource_version')}}" width="280" height="280" /><br />Ios扫描下载
					</li>
					<li>
						<img src="{{asset('admin_panel/img/google/android.png?').config('admin.resource_version')}}" width="280" height="280" /><br />安卓扫描下载
					</li>
				</ul>
			</div>
			<h5>步骤二：</h5>
